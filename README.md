# Industrial Color AI Platform (ICAP) v0.2.5 Enterprise

![ICAP Banner](https://img.shields.io/badge/Industrial_AI-v0.2.5-blue?style=for-the-badge&logo=ai)
...
### 🌟 Ключови подобрения в v0.2.5 Enterprise [Stable]:
...
- **Deep Architectural Refactoring**: Преминаване към модулна архитектура (`app/main.py`, `app/core/lifecycle.py`) за по-лесна поддръжка и скалируемост.
- **Background Indexer Optimization**: Добавена 30-секундна пауза при успешно индексиране за намаляване на дисковото натоварване.
- **Security Hardening**: Пълно прилагане на автентикация към legacy ендпойнтите и маркиране на демо функции.
- **Git Hygiene**: Конфигуриране на Git LFS за ML модели и изчистване на репозиториото.
...
ICAP е проектирана с фокус върху висока производителност:
- **Vision Latency:** Целево време < 15ms при използване на YOLOv11 TensorRT.
- **RAG Speed:** Ефективно индексиране на техническа документация.
- **Accuracy:** Висока прецизност при детекция на дефекти, валидирана чрез вътрешни тестове.
- **Stability:** Проектирана за непрекъсната работа в индустриални Edge среди.
- **Одит:** Пълна проследимост (Audit Trail) на всяко измерване за целите на ISO 9001.

*За детайлна информация относно текущото състояние, вижте **[Roadmap](ROADMAP.md)** и **[Production Readiness](Docs/PRODUCTION_READY.md)**.*
...
| **Кеширане и API** | ![Redis](https://img.shields.io/badge/Redis-DC382D?style=flat&logo=redis&logoColor=white) ![GraphQL](https://img.shields.io/badge/GraphQL-E10098?style=flat&logo=graphql&logoColor=white) ![Strawberry](https://img.shields.io/badge/Strawberry-GraphQL-red?style=flat) |
| **Наблюдаемост** | ![OpenTelemetry](https://img.shields.io/badge/OpenTelemetry-000000?style=flat&logo=opentelemetry&logoColor=white) ![Prometheus](https://img.shields.io/badge/Prometheus-E6522C?style=flat&logo=prometheus&logoColor=white) ![Grafana](https://img.shields.io/badge/Grafana-F46800?style=flat&logo=grafana&logoColor=white) |
| **Инфраструктура** | ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat&logo=postgresql&logoColor=white) ![Alembic](https://img.shields.io/badge/Alembic-Migrations-orange?style=flat) ![MLOps](https://img.shields.io/badge/MLOps-Version_Control-red?style=flat) |
...
```bash
docker build -t icap-v0.2.5 .
docker run -p 8000:8000 --env-file .env icap-v0.2.5
```
...
---
*Изготвено от: ICAP Engineering Team | v0.2.5 | 2026*
