# Industrial Color AI Platform (ICAP) v0.2.6 Enterprise

![ICAP Banner](https://img.shields.io/badge/Industrial_AI-v0.2.6-blue?style=for-the-badge&logo=ai)
<!-- icap-v0.2.6 -->
...
### 🌟 Текущ фокус (v0.2.6):
- **Service Decoupling**: Пълно разделяне на бизнес логиката от API слоя.
- **Industrial RAG**: Семантично търсене в техническа документация.
- **Vision Engine**: Детекция на дефекти чрез YOLOv11 и ViT.
- **Compliance & Audit**: Пълна проследимост на измерванията и AI решенията.
...
- 🎨 **[Color Engine](Docs/COLOR_ENGINE.md)**: Математическо ядро.
...
- 🔌 **[IoT Connectors](Docs/IOT_CONNECTORS.md)**: Свързаност.
- 🍃 **[Sustainability](Docs/SUSTAINABILITY.md)**: CO2 отпечатък [Beta].
- 🕸️ **[Knowledge Graph](Docs/KNOWLEDGE_GRAPH.md)**: Онтология [Research].
...
*Изготвено от: ICAP Engineering Team | v0.2.6 | 2026*
