...
### Добавено
- **GraphRAG:** Пълна интеграция на Knowledge Graph с RAG системата за логическо извличане на информация.
- **Digital Twin:** Нов модул за симулация на производствени процеси и прогнозен анализ.
- **Vision:** TensorRT поддръжка и `torch.compile` оптимизации за VisionEngine.
- **ESG:** Разширен мониторинг на CO2 отпечатъка с реални IoT данни.

### Променено
- **Versioning:** Актуализация на версията на платформата до 0.2.8.
- **Architecture:** Интегриране на DigitalTwinService в глобалното състояние на приложението.

## [0.2.7] — 2026-07-02

### Добавено
- **Documentation:** Секция "Бързо начало" (Getting Started) в README.md.
- **Security:** Валидация на задължителни променливи на средата при стартиране.
- **Database:** Експортирана схема на базата данни в `schema.sql`.
- **Quality:** Интегрирана `pre-commit` конфигурация за автоматизиран качествен контрол.

### Променено
- **Architecture:** Пълна реорганизация на кодовата база — преместване на всички бизнес логика модули в `app/modules/` и актуализиране на импортите в цялата система.
- **Versioning:** Актуализация на версията на платформата до 0.2.7 в целия технологичен стек.
- **Hygiene:** Премахване на `irm_api.py` и почистване на Git кеша от бинарни и локални файлове.
- **Documentation:** Разширяване на README.md с Getting Started и статус на функциите.

## [0.2.6] — 2026-06-30

### Добавено
- **Documentation:** Пълен рефактор на README.md за по-голяма достоверност и инженерен фокус.
- **Documentation:** Детайлна FEATURE MATRIX в `Docs/PRODUCTION_READY.md`.

### Променено
- **Versioning:** Актуализация на версията на платформата до 0.2.6 в целия технологичен стек.
- **Status:** Прецизиране на статусите (Production/Beta/Research) за всички модули.
